...
import { ArrowRight, Lock, Zap, Shield, Eye } from "lucide-react";
import { services } from "@/lib/constants/services";

const iconMap: Record<string, React.ElementType> = {
  "🌐": (props) => <Globe {...props} />,
  "📱": (props) => <Smartphone {...props} />,
  "🛡️": (props) => <Shield {...props} />,
  "🔍": (props) => <Search {...props} />,
  "📋": (props) => <FileText {...props} />,
  "🚨": (props) => <AlertTriangle {...props} />,
};

import { Globe, Smartphone, Search, FileText, AlertTriangle } from "lucide-react";
