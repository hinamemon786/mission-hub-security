...
const blogPosts = [
  {
    ...
    excerpt:
      "A comprehensive guide to the most critical cybersecurity threats facing organizations in 2024.",
  ...
  },
  {
    ...
    excerpt:
      "Learn how to create strong passwords and implement effective password management strategies.",
  ...
  },
  {
    ...
    excerpt:
      "Deep dive into how ransomware attacks work and what you can do to protect your organization.",
  ...
  },
  {
    ...
    excerpt:
      "Why MFA is essential in today's security landscape and how to implement it effectively.",
  ...
  },
  {
    ...
    excerpt:
      "Understanding the Zero Trust security model and its benefits for modern enterprises.",
  ...
  },
  {
    ...
    excerpt:
      "Practical steps to identify and prevent phishing attacks targeting your organization.",
    category: "Security Awareness",
    date: "2024-05-10",
    author: "Fatima Khan",
    readTime: "7 min read",
